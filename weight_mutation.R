weight_mutation <- function(nn, scale = 0.1, p = 0.8){
  ...
  connect_df$Weight[connect_df$perturb_flag] <- connect_df$Weight[connect_df$perturb_flag] + runif(1, min= -scale, max=scale)   #connect_df$perturb_value[connect_df$perturb_flag]
